...
void fvenda(int n, int codigo[], char nome[][30], float valor[], int estoque[]){
    ...
    for(i=0; i<n; i++){
		...
		if(qtd_digitada > 0 && qtd_digitada <= estoque[i]){
...
void finsere(int n, int codigo[], char nome[][30], float valor[], int estoque[]){
		int i;
...
int main() {
	...
	finsere(n, codigo, nome, valor, estoque);
